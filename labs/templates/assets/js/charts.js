...
$(document).ready(function() {		
	...
	Morris.Line({
	  ...
	  data: [
		{ y: '2016-08-25', ankita: 50, harsha: 40, ragesh: 55 },{ y: '2016-08-24', ankita: 22, harsha: 1, ragesh: 222 }
		 ],
	  xkey: 'y',
	  ykeys: ['ankita', 'harsha', 'ragesh'],
	  labels: ['ankita', 'harsha','ragesh'],
	  lineColors:['#0aa699','#d1dade','#b7c1c5'],
	});
